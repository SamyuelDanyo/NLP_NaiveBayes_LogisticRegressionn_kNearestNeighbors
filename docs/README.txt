!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!! MAKE SURE "spamData.mat" is in the < root/src >.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Dependencies:
------------
    Python --version >= 3.7
    Python Standard Library: (time)
    Third Party: (Numpy, matplotlib, sklearn, scipy.io)
...
An example execution is exported to html notebook "NaiveBayes_LogisticRegression_kNearestNeighbors.html" and can be found in <root/docs>
...
2. Navigate to root/src/, home of NaiveBayes_LogisticRegression_kNearestNeighbors.ipynb
3. Execute < jupyter notebook >
4. Click on the "NaiveBayes_LogisticRegression_kNearestNeighbors" notebook.
...
Python Command
---------------
Make sure you Python is installed on your command line.
	//////////////////////////////////////////////////
	// HOW TO THE RUN CODE
	//////////////////////////////////////////////////
